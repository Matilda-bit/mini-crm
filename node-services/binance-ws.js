...
const frontendSocket = new WebSocket('wss://127.0.0.1:8080', {
    rejectUnauthorized: false // Это гарантирует, что сертификаты будут проверяться
  });
//BTC/USD only
...
// Обработчик ошибок для frontendSocket
